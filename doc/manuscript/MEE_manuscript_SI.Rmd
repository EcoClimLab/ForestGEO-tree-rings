...
*Climwin* is a useful analytical tool that automates the process of running and comparing numerous regressions, but its use does not alter results relative to what would be obtained via a more conventional approach; numerous climate drivers and time windows can be compared without climwin (e.g., REFS), and *climwin* could also be used on residual chronologies (**AND WE DID THIS--  ADD SI FIGURE AS EXAMPLE?**). 
...
![](tables_figures/SI_figures/GLS_pre1970_ScottyCreek.png){ width=70% }

**(b) post-1970**

![`r SC_1970break_legend`](tables_figures/SI_figures/GLS_post1970_ScottyCreek.png){ width=70% }
