...
![`r recruitment_plot_BCNM_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_BCI.png){ width=50% }

\newpage
## `r recruitment_plot_HKK_legend`

![`r recruitment_plot_HKK_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_HKK.png){ width=50% }

\newpage
## `r recruitment_plot_SCBI_legend`

![`r recruitment_plot_SCBI_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_SCBI.png){ width=50% }
\newpage

## `r recruitment_plot_LDW_legend`

![`r recruitment_plot_LDW_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_LillyDickey.png){ width=50% }

\newpage
## `r recruitment_plot_HF_legend`

![`r recruitment_plot_HF_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_HarvardForest.png){ width=50% }

\newpage
## `r recruitment_plot_ZOF_legend`

![`r recruitment_plot_ZOF_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_Zofin.png){ width=50% }

\newpage
## `r recruitment_plot_NIO_legend`

![`r recruitment_plot_NIO_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_Niobara.png){ width=50% }


\newpage
## `r recruitment_plot_LT_legend`

![`r recruitment_plot_LT_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_NewMexico.png){ width=50% }

\newpage
## `r recruitment_plot_CB_legend`

![`r recruitment_plot_CB_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_CedarBreaks.png){ width=50% }

\newpage
## `r recruitment_plot_SC_legend`

![`r recruitment_plot_SC_legend`](tables_figures/SI_figures/recruitment_years/Recrutement_years_ScottyCreek.png){ width=50% }
...
![`r decadal_plot_BCNM_legend`](tables_figures/SI_figures/decadal_plots/BCI.png){ width=100% }

\newpage
## `r decadal_plot_HKK_legend`

![`r decadal_plot_HKK_legend`](tables_figures/SI_figures/decadal_plots/HKK.png){ width=100% }

\newpage
## `r decadal_plot_SCBI_legend`

![`r decadal_plot_SCBI_legend`](tables_figures/SI_figures/decadal_plots/SCBI.png){ width=100% }
\newpage
## `r decadal_plot_LDW_legend`

![`r decadal_plot_LDW_legend`](tables_figures/SI_figures/decadal_plots/LD.png){ width=100% }

\newpage
## `r decadal_plot_HF_legend`

![`r decadal_plot_HF_legend`](tables_figures/SI_figures/decadal_plots/HF.png){ width=100% }

\newpage
## `r decadal_plot_ZOF_legend`

![`r decadal_plot_ZOF_legend`](tables_figures/SI_figures/decadal_plots/ZN.png){ width=100% }

\newpage
## `r decadal_plot_NIO_legend`

``` {r eval=FALSE}
![`r decadal_plot_NIO_legend`](tables_figures/SI_figures/decadal_plots/NIO.png){ width=100% }
``` 

\newpage
## `r decadal_plot_LT_legend`

![`r decadal_plot_LT_legend`](tables_figures/SI_figures/decadal_plots/NM.png){ width=100% }

\newpage
## `r decadal_plot_CB_legend`

![`r decadal_plot_CB_legend`](tables_figures/SI_figures/decadal_plots/CB.png){ width=100% }

\newpage
## `r decadal_plot_SC_legend`

![`r decadal_plot_SC_legend`](tables_figures/SI_figures/decadal_plots/SC.png){ width=100% }
