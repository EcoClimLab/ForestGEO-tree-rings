...
To verify that our methods gave similar results to traditional methods, we conducted a formal comparison for four well-studied species: PSME (Cedar Breaks, Utah), ABAL (Zofin), PIMA (Scotty Creek), and LITU (SCBI).
