...
library(knitr)
library(kableExtra)
ss_table <- read.csv("tables_figures/qualitative_results_comparison.csv", stringsAsFactors = FALSE, check.names = FALSE)
kable(ss_table, format = "latex", booktabs = TRUE, longtable = TRUE,  escape = F, linesep = c('\\addlinespace'))%>%
  ...
  kable_styling(latex_options = c( "hold_position", "repeat header"), protect_latex = T, font_size = 9) 

# refs in this table need to go in the nocite field below
```
---
nocite: | 
  @alfaro-sanchez_growth_2017; @vlam_temperature_2014; @helcoski_growing_2019; @maxwell_declining_2016; @aus_de_ar_tree_2018; @bumann_assessing_2019; @tumajer_increasing_2017; @sniderhan_growth_2016
---
