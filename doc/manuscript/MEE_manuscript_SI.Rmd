...
![**Figure S2 | Comparison of climwin output by growth metric:** Current example is PET at Little Tesque, NM. (I'm not sure if this is interesting enough to present in the main text. If not, we should have at least one example in the SI)](tables_figures/NewMexico_pet.png)