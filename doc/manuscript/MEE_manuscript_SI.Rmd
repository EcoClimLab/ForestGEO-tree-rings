...
We also conducted a formal comparison using identical tree-ring and climate data for four species: PSME (Cedar Breaks, Utah), ABAL (Zofin), PIMA (Scotty Creek), and LITU (SCBI; Figs. `r all_traditional_comparisons`). These species were selected for analysis because they have been well-studied in the past, and there was no manipulation of study species based on analysis results. 
