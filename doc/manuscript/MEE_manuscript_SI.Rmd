...
![**Figure S1 | (Comparison of traditional approaches with ours).**  (THIS FIGURE IS JUST A MOCK-UP --NOT REAL DATA. REAL FIGURE WILL INCLUDE 3-4 COMMONLY STUDIED SPECIES FROM DIFFERENT SITES.) ](tables_figures/SI_figures/mock_comparison_traditional_method.png){ width=70% }
