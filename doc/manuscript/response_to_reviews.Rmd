...
**Regarding the detrending method, most detrending methods have been shown to retain the climate signal in many paleoclimate reconstructions. There are some ongoing nuanced discussions that are important for paleoclimate reconstructions such as retaining the medium frequency variance and examining the how segment length impacts that frequency, and about how changes near the end of the series (increasing or decreasing trend in growth) can impact the detrending and thus climate signal. However, for the purposes of this paper, the methods used here have been shown over and over again to retain the climate signal. We have added the following sentence to make this point: "These types of detrending methods are used to maximize the climate signal in tree-ring paleoclimate reconstructions and thus have been shown to retain the climate signal while removing the influence of other non-climatic drivers [@fritts_tree_1976; @cook_time_1985]."**
...
*(These are citations with special characters in the name). Look into this. I don't see a problem in the draft proof.*
