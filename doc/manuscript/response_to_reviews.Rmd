...
*Insert ref: This is fundamentally driven by the limitation that it is not possible to use a contemporary set of tree cores to obtain a representative sample of a species's population at all time points throughout the history of a dynamically changing stand (**REF**).*

*review biases, pubs- metion in discussion*
...
*[GitHub issue # 137](https://github.com/EcoClimLab/ForestGEO-tree-rings/issues/137)*
...
*just need to clarify this in methods and/or SI*
