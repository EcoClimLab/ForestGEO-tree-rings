...
# Fig2- relationship of ∆r and ∆AGB to DBH (all site-species combinations)
# Fig3- climate senstivity (SCBI example): (a) Helcoski quilt plot, (b) Climwin panel a, (c) GLS output
# Fig4- multipanel- GLS results for climate sensitivity at all sites (3 columns with the 3 variable type groupings, 1 row per site)
...
(**[ISSUE #25 in ForestGEO-climate-sensitivity ](https://github.com/EcoClimLab/ForestGEO-climate-sensitivity/issues/25): How do we solve this? Any possibility besides subjectively selecting the drivers? Maybe try analysis without detrending**)
