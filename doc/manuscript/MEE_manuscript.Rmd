...
Growth rates changed directionally over time--i.e., there was a significant effect of `year` in the GLS model-- for # of the # species- site combinations tested (Table `r interactions_and_year_summaries`).
...
`r interactions_and_year_summaries_legend`
