...
- One commonly applied approach is to assume that $BAI$ is fundamentally independent of size [@biondi_theory-driven_2008]--an assumption that was developed for open-grown trees [@biondi_theory-driven_2008] but that has subsequently been applied in other settings (DENDRO_REFS).
...
*(discuss why these results are reliable)*

We believe our analysis methods to be robust,
(noting that assumption of constant BAI, as per @biondi_theory-driven_2008, is not appropriate based on our DBH results)
...
Several of our sites (HKK, SCBI, LDW, HF, ... *Coauthors, I need help here.*) are known to have suffered major disturbances within the past 1.5 centuries [Appendix `r site_details_appendix`; REFS: Baker,...; @bourg_initial_2013], and growth declines at these sites are consistent with increasing competition as young stands mature.
...
Even within mature forests, light-demanding species that establish in gaps (e.g., *Jacaranda copaia* at BCNM, *Populus tremuloides* at CB) would tend to experience an increasingly competitive environment. 
...
In the Czech Republic (ZOF), acid deposition is known to have reduced growth in the *(DECADES)* (**REFS**), and *(this apparently influenced different species in different directions)*.
