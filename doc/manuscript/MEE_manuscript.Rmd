...
The prevalence of interactive $DBH$-climate effects reinforces the concepts that drought tends to have a disproportionate impact on large trees [@bennett_larger_2015; @mcgregor_tree_nodate] and that *temperature sensitivity can vary across size classes (Rollinson et al. in review)*, implying that size should be considered in tree-ring analyses of climate sensitivity.
