...
Trees of species represented within the ForestGEO plots were cored within the plot (n=#) and/or in the vicinity (n=#; max distance: # km), following a variety of sampling protocols designed to meet the varied objectives of the original studies (Table S1). 
...
Interactions were significant for over half of $DBH$-precipitation variable interactions for all three growth metrics (*51% for all*; Table S4).
...
Interactions between temperature variables and $DBH$ were significant for *~40%* of cases considered (Table S4). 
