...
## potential reviewers: Jane Foster, M. Evans,  van der Pol, DEN team, Klesse
...
These included, but were not limited to, shade-tolerant species at sites where they presumably established under closed-canopy conditions (e.g., *Trichilia tuberculata* and *Tetragastris panamensis* at BCI; *Fagus* spp. at SCBI and Žofín, *Acer saccharum* at LDW, *Picea* spp. at Žofín and CB; Table `r species_table`).  
...
**Our new tree-ring analysis method allows simultaneous consideration of the effects of dominant climate drivers, tree size, and slowly changing environmental drivers on annual growth (Fig. `r schematic`), yielding results that are consistent with those that would be obtained using conventional methods (Figs. `r SCBI_example`, `r all_traditional_comparisons`;  Table `r qualitative_results_comparison`) and with our current understanding of forest dynamics.** 
Across diverse climates and forest types (Table `r sites`), growth rates of `r n_species` tree species generally responded positively to water availability ($PPT$, $PDF$, or **$SF$**)--at least up until the long-term mean--
...
Interactions between climate variables and $DBH$ not unusual (Table `r interactions_and_year_summaries`, Fig. `r interactions_fig`), with larger trees tending to be more drought sensitive (REFS).
...
It is notable that growth rates of most species declined...
