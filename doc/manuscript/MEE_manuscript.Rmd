...
```
Responses to precipitation amount ($PPT$) and frequency ($PDF$) were included in the best model for all but one species (Fig. `r clim_sens`).
...
There were also cases where previous growing season conditions were influential, including  temperature variables at Niobrara and Cedar Breaks. 
