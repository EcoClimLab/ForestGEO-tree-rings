...
**The relative importance of $DBH$ and climate shifted across growth metrics and climates (Figs. 5, S#_#).** (*It will be easier to fill this in once we complete [ISSUE #66 in ForestGEO-climate-sensitivity ](https://github.com/EcoClimLab/ForestGEO-climate-sensitivity/issues/66)*).
...
However, there were exceptions (e.g., at Little Tesuque; Fig. **5**).
The relative importance of climate was modest at sites including SCBI, ..., and stronger at sites including Little Tesuque, ... (Figs **5**, **S#**-**S#**). 
