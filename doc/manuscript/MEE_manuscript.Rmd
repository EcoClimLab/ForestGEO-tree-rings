...
We checked for collinearity among the selected climate variables, removing cloud group variables when they were *too closely correlated* with temperature or precipitation group variables. 
Furthermore, we removed any variable with a variance inflation factor > 10. (**[ISSUE #109 in ForestGEO-climate-sensitivity ](https://github.com/forc-db/Global_Productivity/issues/109))
...
We checked for collinearity among the full set of variables and removed any variable with a variance inflation factor > 10. (**[ISSUE #109 in ForestGEO-climate-sensitivity ](https://github.com/forc-db/Global_Productivity/issues/109))
...
*Helene Muller-Landau argues that, from tree scaling/geometry perspective, $\Delta r$ is the closest to being size-independent (as opposed to BAI) (see [Francis et al. (2017)](https://onlinelibrary.wiley.com/doi/full/10.1111/geb.12604)).* 
