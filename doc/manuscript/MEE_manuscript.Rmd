...
![**Figure 4 | Growth sensitivity to DBH: (a) $\Delta r$, (b) $BAI$, (c) $\Delta AGB$.** Only relationships included in the top model for each site are shown. It's tough to fit all the plots, so we may have to adjust this somehow.](tables_figures/DBH_responses.png)
