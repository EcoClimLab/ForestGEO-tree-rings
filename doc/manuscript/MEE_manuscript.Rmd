...
Within *climwin*, we specified a mixed effects model using species (when $n \ge 3$) and core identity as random effects: `residual growth index ~ [climate] + (1 | sp) + (1 | treeID)`.
...
Across diverse climates and forest types (Table `r sites`), growth rates of `r n_species` tree species generally responded positively to water availability ($PPT$ or $PDF$)--at least up until the long-term mean--
