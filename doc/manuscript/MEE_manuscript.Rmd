...
For species exhibiting a pulse of recruitment in the past followed by little subsequent recruitment (e.g., **SPECIES, FIGURES**), persistent differences in growth rates among individuals would naturally lead to a trend of declining growth, as faster-growing individuals reach various size thresholds earlier [@brienen_tree_2017].
...
This can occur, for example, when a light-demanding species is no longer recruiting under a closed canopy (e.g., *Quercus* spp. at SCBI), such that fast-growing individuals disappear from progressively larger cohorts as time proceeds. 
In secondary stands, particularly those where the majority of trees established at a similar time (**SCBI, HF,...**; Appendix `r site_details_appendix` **FIGURES**), growth declines are consistent with the tendency for faster tree growth during early succession (**REFS**), and with increasing competition and declining woody productivity as young stands mature [e.g., @pregitzer_carbon_2004; @goulden_patterns_2011].
Even within mature forests, light-demanding species that establish in gaps (e.g., *Jacaranda copaia* at BCNM, *Populus tremuloides* at CB; Table `r species_table`) would tend to experience an increasingly competitive environment through time.
