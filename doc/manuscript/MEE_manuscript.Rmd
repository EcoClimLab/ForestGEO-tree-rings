...
Patrick J. Baker^9^,
Sarayudh Bunyavejchewin^10^,
Paolo Cherubini^11^,
Justin Cooper^12^,
Stuart J. Davies^2^,
Cameron Dow^1,13^,
Ryan Helcoski^1^,
[Jakub Kašpar](0000-0003-1780-6310)^14^,
[James Lutz]( 0000-0002-2560-0710)^15^,
Ellis Q. Margolis^6^,
Justin Maxwell^16^,
Sean McMahon^2,17^,
Camille Piponiot^1,2, 18^,
Sabrina Russo^8^,
[Pavel Šamonil](0000-0002-7722-8797)^14^,
Anastasia Sniderhan^7^,
Alan J. Tepley^1,19^,
[Ivana Vašíčková](0000-0002-6070-5956)^14^, 
Mart Vlam^20^,
Peter Zuidema^20^
...
6. U.S. Geological Survey, Fort Collins Science Center, Jemez Mountains Field Station, Los Alamos, NM 87544, USA
...
9. School of Biological Sciences, Monash University, Clayton, Victoria 3800, Australia

10. National Parks Wildlife and Plant Conservation Department, Chatuchak, Bangkok 10900, Thailand

11. Swiss Federal Institute for Forest, Snow and Landscape Research, CH-8903 Birmensdorf, Switzerland

12. University of Alberta; Edmonton, Alberta, Canada

13. Department of Forestry, Purdue University, West Lafayette, IN 47907, USA

14. Department of Forest Ecology, The Silva Tarouca Research Institute for Landscape and Ornamental Gardening, Lidická 25/27, 602 00 Brno, Czech Republic

15. S. J. & Jessie E. Quinney College of Natural Resources and the Ecology Center, Utah State University, Logan, UT 84322, USA

16. Department of Geography, Indiana University, Bloomington, Indiana, USA

17. Smithsonian Environmental Research Center, Edgewater, MD, USA

18. CIRAD, Montpellier, France

19. Canadian Forest Service, Northern Forestry Centre, Edmonton, Alberta, Canada

20. Forest Ecology and Forest Management Group, Wageningen; Wageningen, The Netherlands
...
GLS_BCNM_legend = "Figure S35. Best GLS models including climate and DBH for Barro Colorado Nature Monument (Panama)"
GLS_BCNM_year_legend = "Figure S36. Best GLS models including climate, DBH, and year for Barro Colorado Nature Monument (Panama)"
GLS_HKK_legend = "Figure S37. Best GLS models including climate and DBH for Huai Kha Khaeng (Thailand)"
GLS_HKK_year_legend = "Figure S38. Best GLS models including climate, DBH, and year for Huai Kha Khaeng (Thailand)"
GLS_SCBI_legend = "Figure S39. Best GLS models including climate and DBH for the Smithsonian Conservation Biology Institute (Virginia, USA)"
GLS_SCBI_year_legend = "Figure S40. Best GLS models including climate, DBH, and year for the Smithsonian Conservation Biology Institute (Virginia, USA)"
GLS_LDW_legend = "Figure S41. Best GLS models including climate and DBH for Lilley Dickey Woods (Indiana, USA)"
GLS_LDW_year_legend = "Figure S42. Best GLS models including climate, DBH, and year for Lilley Dickey Woods (Indiana, USA)"
GLS_HF_legend = "Figure S43. Best GLS models including climate and DBH for Harvard Forest (Massachusetts, USA)"
GLS_HF_year_legend = "Figure S44. Best GLS models including climate, DBH, and year for Harvard Forest (Massachusetts, USA) "
GLS_ZOF_legend = "Figure S45. Best GLS models including climate and DBH for Zofin Forest (Czech Republic)"
GLS_ZOF_year_legend = "Figure S46. Best GLS models including climate, DBH, and year for Zofin Forest (Czech Republic)"
GLS_NIO_legend = "Figure S47. Best GLS models including climate and DBH for Niobrara (Nebraska, USA)"
GLS_NIO_year_legend = "Figure S48. Best GLS models including climate, DBH, and year for Niobrara (Nebraska, USA)"
GLS_LT_legend = "Figure S49. Best GLS models including climate and DBH for Little Tesuque (New Mexico, USA)"
GLS_LT_year_legend = "Figure S50. Best GLS models including climate, DBH, and year for Little Tesuque (New Mexico, USA)"
GLS_CB_legend = "Figure S51. Best GLS models including climate and DBH for Cedar Breaks (Utah, USA)"
GLS_CB_year_legend = "Figure S52. Best GLS models including climate, DBH, and year for Cedar Breaks (Utah, USA)"
GLS_SC_legend = "Figure S53. Best GLS models including climate and DBH for Scotty Creek (Northwest Territory, Canada)"
GLS_SC_year_legend = "Figure S54. Best GLS models including climate, DBH, and year for Scotty Creek (Northwest Territory, Canada)"

SC_1970break_legend = "Figure S55. Climate responses at Scotty Creek (Northwest Territory, Canada) before and after 1970."

RW_interactions_all_legend = "Figure S56. (RW_interactions_all)"
BAI_interactions_all_legend ="Figure S57. (BAI_interactions_all)"

decadal_plot_BCNM_legend = "Figure S58. (Decadal BCNM)"
decadal_plot_HKK_legend = "Figure S59. (Decadal HKK)"
decadal_plot_SCBI_legend = "Figure S60. (Decadal SCBI)"
decadal_plot_LDW_legend = "Figure S61. (Decadal LDW)"
decadal_plot_HF_legend = "Figure S62. (Decadal HF)"
decadal_plot_ZOF_legend = "Figure S63. (Decadal ZOF)"
decadal_plot_NIO_legend = "Figure S64. (Decadal NIO)"
decadal_plot_LT_legend = "Figure S65. (Decadal LT)"
decadal_plot_CB_legend = "Figure S66. (Decadal CB)"
decadal_plot_SC_legend = "Figure S67. (Decadal SC)"
...
Tree rings provide a uniquely valuable long-term record for understanding how climate and other environmental drivers shape forest productivity.
...
Here, we develop a new method to simultaneously model non-linear effects of objectively determined principle climate drivers, reconstructed tree diameter ($DBH$), and year in generalized least squares models that account for the temporal autocorrelation inherent to each individual tree's growth.
We apply this method to tree-ring data from `r n_trees_all` trees representing `r n_species` species at ten globally distributed sites.
Our analysis identified similar climate drivers to those obtained via traditional methods. 
Growth responses were predominantly positive to precipitation and negative to temperature, with both included in 80% of top models, and with non-linear responses prevalent (*>50%* of relationships).
Growth rates--expressed as ring widths, basal area increments, or biomass increments--varied non-linearly with $DBH$.
Interactions between $DBH$ and climate were common (*43%* of cases tested). 
Accounting for $DBH$, growth rate varied directionally over time in most species-- declining in *90%*.
...
As a rigorous analytical framework for statistically modeling tree growth responses to the most important climate drivers, $DBH$, and year in nonlinear models, our method provides a parsimonious approach for characterizing multiple interacting drivers of tree growth, opening the door for novel analyses using tree-rings to improve our understanding of forest responses to global change. 
...
Spanning time scales of decades to centuries or even millennia, they provide by far the most robust method for characterization of the interannual climate sensitivity of tree growth [@fritts_tree_1976; @braker_measuring_2002] and how it is changing [@sniderhan_growth_2016; @maxwell_declining_2016; @babst_twentieth_2019; @wilmking_global_2020]. 
...
They also provide the long-term perspective critical to understanding how slowly changing environmental drivers including rising atmospheric carbon dioxide (CO~2~) and directional climate change are influencing tree growth and forest productivity [e.g., @levesque_water_2017; @mathias_disentangling_2018; @walker_integrating_2020].
...
Yet, collection and analysis of dendrochronological records has been traditionally been optimized to detect climate signals rather than to predict forest productivity, its climate sensitivity, and how it may be changing [@cherubini_potential_1998; @nehrbassahles_influence_2014; @klesse_sampling_2018;@babst_when_2018; @wilmking_global_2020].
...
In particular, analysis of species-level chronologies does not allow characterization of known variation in climate sensitivity in relation to tree size, canopy position, or microhabitat [e.g., @bennett_larger_2015; @mcgregor_tree_2020; @rollinson_climate_nodate].
...
Furthermore, temperature and moisture are known to jointly shape tree growth [@beedlow_importance_2013; @foster_predicting_2016] and forest productivity [e.g., @alexander_relative_2018; @banbury_morgan_global_nodate], yet growth sensitivity to their additive or interactive effects, potentially operating over different time windows, is not commonly considered [but see @meko_seascorr_2011; @foster_predicting_2016; @sanchez-salguero_disentangling_2015]. 

Tree diameter at breast height ($DBH$) is closely correlated with numerous variables affecting tree growth rate [e.g., height, crown size and position, root mass; @enquist_global_2002] and therefore is one of the most important variables influencing growth [e.g., @muller-landau_testing_2006; @foster_predicting_2016] and its climate sensitivity [e.g., @bennett_larger_2015; @mcgregor_tree_2020].
...
While convenient for identifying climate signals [@fritts_tree_1976], this approach is not optimal for subsequent inference of the climate sensitivity of forest productivity [@babst_when_2018].
...
Moreover, carbon allocation to woody growth -- as opposed to leaf or root production, reproduction, defenses, etc. -- is known to decline as individual trees and forest stands stands age [@goulden_patterns_2011; @pregitzer_carbon_2004; @meinzer_age-related_2011]. 
However, tree size and time are almost inextricably linked (because each individual core increases in $DBH$ through time) and therefore difficult to disentangle,   being subject to various sampling and analysis biases [@cherubini_potential_1998; @brienen_detecting_2012; @nehrbassahles_influence_2014; @peters_detecting_2015; @sullivan_effect_2016; @bowman_detecting_2013; @brienen_tree_2017; @hember_tree_2019].  
...
We analyzed tree-ring data, most previously collected, from ten sites ranging from 9.15$^\circ$ to 61.30$^\circ$ N latitude and representing a wide range of forest and tree types: tropical broadleaf deciduous and evergreen, temperate broadleaf deciduous and needleleaf evergreen, and boreal needleleaf evergreen (Tables `r sites`, `r site_details`, `r species_table`).
...
Trees of species represented within the ForestGEO plots were cored within the plot (n=5) and/or nearby within similar forest types (n=5), following a variety of sampling protocols designed to meet the varied objectives of the original studies (Tables `r site_details`, `r sampling_details_table`). 
...
**Table 1 | Sites included in this analysis**. Here and throughout, sites are ordered by descending mean annual temperature. Additional site information is provided in Appendix `r site_details_appendix`, Table `r site_details`, and species and their sample sizes are detailed in Tables `r species_table`-`r sampling_details_table`. 
...
---
nocite: | 
  @vlam_temperature_2014; @maxwell_declining_2016; @sniderhan_growth_2016; @alfaro-sanchez_growth_2017; @helcoski_growing_2019 @gonzalez-akre_scbi-forestgeoscbi-forestgeo-data_2020-1; @bumann_assessing_2019; @samonil_individual-based_2013; @kaspar_species-specific_nodate; @alexander_potential_2019; @finzi_carbon_2020; @birch_birch_2020; @birch_birch_2020-2; @birch_birch_2020-3; @birch_birch_2020-4
---
...
To remove low-frequency variation that most likely represents responses to non-climatic drivers (*e.g.*, growth and aging of the tree, change in competitive dynamics, atmospheric pollution), we detrended the response variables by fiting penalized thin plate regression splines in generalized additive models (GAM, function *gam* and *s* in R Package *mgcv*, [@wood_fast_2011]) to individual growth records ($RW$, $BAI$, or $\Delta AGB$) from each core, thereby producing residuals. The smoothing parameters were automaticaaly selected by the *gam* function by generalised cross-validation (GCV).
...
Furthermore, we explored alternate methods of climate variable selection for the two sites that have undergone the most rapid changes in climate and tree growth: LT, where increasingly warm drought has dramatically reduced growth [@touchan_millennial_2011; @williams_temperature_2013], and SC, where rapidly rising temperatures are causing melting permafrost, summer moisture stress, and growth declines [@sniderhan_growth_2016]. 
...
Having identified candidate climate drivers in temperature and precipitation variable groups, we next combined climate variables (all models) and $DBH$ (models with $DBH$ and its climate interactions) in a linear mixed-effects models (function *lme* in R package *nlme*), with core identity as random intercept and $year$ as continuous time covariate for the within-group correlation structure (function *corCAR1*). We will reffer to this model as a generalized least squares (GLS) model (Fig. `r schematic`).

Before running the models, we checked for collinearity among the candidate variables using the *vifstep* function [@naimi_where_2014] and removed any variable with a variance inflation factor > 3 (none required removal).
...
As an example of a full model for $log[\Delta r]$ would look like this in *R*:
 *lme($log[\Delta r]$ ~ $PET$ + I($PET$^2) + $T_{min}$ + I($T_{min}$^2) + $DBH$ + I($DBH$^2)",  random = ~1|$coreID$, correlation = corCAR1(form=~$Year$|$coreID$), data = $x$, na.action = "na.fail", method = "ML")* 
where $x$ is a complete data set (with no missing value) for one species at one site. The method is set to maximum likelihood (*ML*) during the model selection phase, but to restricted maximizing likelihood (*REML*) once the best model is identified.
...
To avoid severe big-tree selection biases [@brienen_detecting_2012], we also required that the minimum $DBH$ sampled be $\le$ 25 cm, if present.  
...
In 8 of 20 cases, both the optimal climate variable and time window were identical across growth metrics (e.g., Fig. `r climwin_SCBI_W`). 
In 10 cases, *climwin* identified the same climate variable but different (often overlapping) time windows (e.g., Fig. `r climwin_SCBI_T`). 
Finally, in two cases of variables that had only weak effects and mixed responses among species in the final models (temperature variable group at HKK, precipitation variable group at HF; Figs. `r clim_sens`, `r GLS_HKK`, `r GLS_HF`), *climwin* identified different climate variables and different time windows (e.g., Fig. `r climwin_HKK_T`). 
...
#NIO: ppt pOct-pDec (3mo), TMP pJune (1mo)
...
$PPT$ was selected over $PDF$ as the top variable in five of the eight sites with both variables available (but had no significant main effect at one of these, NIO), and was the only option at two sites (LT and CB).
...
At LDW, the most influential windows were limited to the current spring and early summer, whereas optimal windows at three sites extended back to the previous fall (LT, CB) or summer (SCBI).
...
*(predominantly negative temperature responses imply likely growth reductions under warming)*
...
The nonlinear form of most climate growth responses implies that as the climate changes, non-stationary climate responses, already common [@wilmking_global_2020], are likely to become more prevalent. 
...
Growth rate--whether measured as $RW$, $BAI$, or $\Delta AGB$-- varied nonlinearly with $DBH$ for the vast majority of site-species combinations (`r round(n_spst_RW_DBH_bm/ n_spst_DBH_analyzed*100)` - `r round(n_spst_dAGB_DBH_best_model/ n_spst_DBH_analyzed*100)`% depending on growth metric; Fig. `r size`). 
...
However, our results remain subject to the potential influence of some potential sampling and survivorship biases that can influence overall trends in positive or negative directions [Fig. `r year_fig`; @brienen_detecting_2012; @groenendijk_no_201; @brienen_tree_2017; @nehrbassahles_influence_2014].
...
The observed trends should therefore be interpreted with caution, and as representative of only the sampled trees, as opposed to all individuals of the species that existed throughout the time frame analyzed.
Within this context, signals of changing growth rate over time are attributable to some combination of stand dynamics (e.g., recruitment and succession, changing stand structure) and environmental drivers (e.g., climate drivers other than those selected by *climwin*, rising atmospheric CO~2~, deposition of SO~2~ and NO~x~).
...
In cases such as this, a non-linear response function to $year$, or incorporation of data on pollution, would be needed to accurately capture changing growth trends, but that is beyond the scope of the current analysis.
In New Mexico (LT), where growth rates of *Pinus Ponderosa* declined, we suspect that the dominant climate drivers identified here might not fully capture a strong regional drying trend [@touchan_millennial_2011; @williams_temperature_2013], although sampling biases remain possible.
...
There is a notable lack of evidence that growth rates of any species benefited substantially from increasing CO~2~, corroborating previous analyses from HKK [@nock_longterm_2011; @van_der_sleen_no_2015; @groenendijk_no_2015; but see @brienen_tree_2017] 
...
This aligns with the preponderance of studies using tree-rings to infer growth responses to rising CO~2~ [e.g., @girardin_no_2016; @groenendijk_no_2015; @hararuk_tree_2019; @walker_integrating_2020], albeit contrasting with some [e.g., @voelker_historical_2006; @hember_tree_2019].
A growth benefit of CO~2~ is potentially expected based on physiological mechanisms and has been observed in young forests in experimental settings [@walker_integrating_2020]. 
...
and that current or recently living trees commonly show growth declines in response to some combination of stand dynamics and environmental change (Fig. `r year_fig`).
While traditional dendrochronology methods, particularly those focused on climate reconstruction, generally sample and analyze data in order to minimize many of these effects, they are critical for understanding forest productivity in an era of global change.
