...
In the Czech Republic (ZOF), acid deposition dramatically reduced growth in  *(DECADES)* [**REFS**], as captured in our records (Fig. `r decades_figure_ZOF`), and *this influenced linear growth trends of different species in differently within the GLS model*. 
