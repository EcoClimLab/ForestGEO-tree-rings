...
**We present a new method that allows simultaneous consideration of the effects of objectively determined principle climate drivers and tree size on annual growth (Fig. `r schematic`).**
...
We show that ..
Most notably, the fact that our approach is able to simultaneously model the effects of climate, DBH, and year allows...
