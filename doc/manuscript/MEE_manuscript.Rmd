...
It is notable that growth rates are changing directionally for the majority (`r percent_sig_neg_trend_of_analyzed`, depending on growth metric) of site-species combinations that could be analyzed (Fig. `r year_fig`).
