...
This finding was consistent with an independent analysis (Appendix `r decadal_analysis_appendix`, Figs. `r decadal_analysis_figs_all`) and corroborates a previous analysis from HKK showing decreases in $BAI$ over time [@nock_longterm_2011].
*(have there been analyses of this at any other sites?)*
Although $DBH$ and $year$ are difficult to disentangle [e.g., @peters_detecting_2015], decent coverage of $DBH$ x $year$ matrices for the species analyzed, together with general consistency across growth metrics and analysis methods (Appendix `r decadal_analysis_appendix`, Figs. `r year_fig`, `r decadal_analysis_figs_all`) suggest that our approach is generally reliable.
