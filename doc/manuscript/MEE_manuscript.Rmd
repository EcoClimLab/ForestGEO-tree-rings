...
climwin_diffV_diffW_legend = "Figure S7. (TMP/TMN at BCNM)"

GLS_BCNM_legend = "Figure S9. Best GLS models for Barro Colorado Nature Monument (Panama)"
...
#sameV_diffW: BCNMp, BCNMt, CBp, CBt, HFt, HKKp, LDWt, NMp, SCBIt, SCp, ZOFt
...
There were eight site-species combinations for which only a precipitation term was significant (2 at BCNM, 3 at SCBI, 2 at LDW, and 1 at CB), one for which only a temperature term was significant (CHTA at HKK), and none with no significant climate responses. 
