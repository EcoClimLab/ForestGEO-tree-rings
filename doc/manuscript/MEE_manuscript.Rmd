...
Directional climate change (as opposed to interannual variation), rising atmospheric carbon dioxide (CO~2~), and atmospheric deposition  of sulfur dioxide (SO~2~) and nitrogen oxides (NO~x~) are all potentially influencing tree growth [e.g., @levesque_water_2017; @mathias_disentangling_2018; @walker_integrating_2020].
