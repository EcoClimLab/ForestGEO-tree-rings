...
decadal_analysis_figs_all = "S32-S41"
decadal_plot_BCNM = "S32"
decadal_plot_HKK = "S33"
decadal_plot_SCBI = "S34"
decadal_plot_LDW = "S35"
decadal_plot_HF = "S36"
decadal_plot_ZOF = "S37"
decadal_plot_NIO = "S38"
decadal_plot_LT = "S39"
decadal_plot_CB = "S40"
decadal_plot_SC = "S41"
...
decadal_plot_BCNM_legend = "Figure S32. (Decadal BCNM)"
decadal_plot_HKK_legend = "Figure S33. (Decadal HKK)"
decadal_plot_SCBI_legend = "Figure S34. (Decadal SCBI)"
decadal_plot_LDW_legend = "Figure S35. (Decadal LDW)"
decadal_plot_HF_legend = "Figure S36. (Decadal HF)"
decadal_plot_ZOF_legend = "Figure S37. (Decadal ZOF)"
decadal_plot_NIO_legend = "Figure S38. (Decadal NIO)"
decadal_plot_LT_legend = "Figure S39. (Decadal LT)"
decadal_plot_CB_legend = "Figure S40. (Decadal CB)"
decadal_plot_SC_legend = "Figure S41. (Decadal SC)"
...
~~A variety of methods have been used to analyze directional changes in growth rate through time, including conservative detrending, where a mathematical function (e.g., negative exponential or stiff spline) is fit to growth trends in each individual core and residuals analyzed for trends and basal area correction, which assumes that the growth in a tree's basal area ($BAI$) is fundamentally independent of size [@peters_detecting_2015]. A more reliable alternative is regional curve standardization, which uses an average age or size curve to describe ontogeny (*Esper et al. 2003*) and can be used in the context of multiple regressions or mixed-effects models [*REFS in @hember_tree_2019*].~~
...
However, are results remain subject to the influence of some potential sampling and survivorship biases that can influence overall trends in positive or negative directions [Fig. `r year_fig`; @brienen_detecting_2012; @brienen_tree_2017; @nehrbassahles_influence_2014].
While we have made efforts to control for the most severe potential biases (see Methods), and while the statistical model applied here in theory accounts for persistent growth differences among trees through a random effect of tree, some potential biases are difficult, if not impossible, to control for [@brienen_tree_2017].
The observed trends must therefore be interpreted with caution, and in light of the fact that growth trends inferred from tree rings can be strongly shaped by tree demography [@brienen_tree_2017].

*...  corroborates previous analyses from HKK showing growth decreases over time [@nock_longterm_2011; @van_der_sleen_no_2015; @groenendijk_no_2015, but see @brienen_tree_2017].*

*coauthors, I'd appreciate site-specific feedback on the two following paragraphs:*
...
The majority of negative growth trends observed here are probably attributable to successional stand dynamics as cohorts and stands age. 
For species exhibiting a pulse of recruitment in the past and little subsequent recruitment (e.g., **SPECIES, FIGURES**), variation in growth rates among individuals would naturally lead to a trend of declining growth, as faster-growing individuals reach various size thresholds earlier [@brienen_tree_2017].
Such a trend is not indicative of a directional response to changing environmental conditions that would be generalizable across stands (e.g., rising atmospheric CO~2~), but does indicate a decline of the species within the stand. 
This can occur, for example, when a light-demanding species is no longer recruiting under a closed canopy, which is the likely explanation for declines in several species (e.g., **SPECIES, FIGURES/TABLES**).
In secondary stands, particularly those where the majority of trees established at a similar time (**SCBI, HF,...**; Appendix `r site_details_appendix` **FIGURES**), growth declines are consistent with the tendency for faster tree growth during early succession (**REFS**), and with increasing competition as young stands mature (**REFS**).
Even within mature forests, light-demanding species that establish in gaps (e.g., *Jacaranda copaia* at BCNM, *Populus tremuloides* at CB; Table `r species_table`) would tend to experience an increasingly competitive environment.
...
In cases such as this, a non-linear response function to $year$, or incorporation of data on pollution, would be needed to accurately characterize changing growth trends, but that is beyond the scope of the current anlaysis.
In New Mexico (LT), *we suspect that a strong drying trend is not fully captured by the dominant climate drivers (?).*
At Scotty Creek, rapid warming and melting permafrost are altering hydraulic conditions, resulting in growth declines, high mortality, and low recruitment of *Picea mariana* [@sniderhan_growth_2016; @dearborn_permafrost_2020]. 

There is a notable lack of evidence that growth rates of any species are are benefiting substantially from increasing CO~2~. 
With a few potential exceptions (*Fagus sylvatica* at ZOF, *Picea pungens* and *Pinus flexilis* at CB; Fig. `r year_fig`), any growth benefit from elevated CO~2~ was generally outweighed by successional changes or chronic environmental shifts.
A growth benefit of CO~2~ is potentially expected based on physiological mechanisms and has been observed in young forests in experimental settings [@walker_integrating_2020]; however, it does not appear to be substantial for the older trees in natural forest settings analyzed here. 
