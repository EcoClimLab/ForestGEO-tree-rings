...
We note that a modification of our analysis method (modeling $year \times$ climate interactions instead of $climate \times$ climate interactions) could potentially be used to account for directional changes in climate sensitivity, which have commonly been observed [REFS- Maxwell, Helcoski; @peltier_tree_2020; @zuidema_recent_2020].
