...
![`r GLS_BCNM_legend` `r GLS_generic_legend`](tables_figures/SI_figures/composite_plots/BCI.png){ width=85% }


\newpage
## `r GLS_SCBI_legend`

![`r GLS_SCBI_legend` `r GLS_generic_legend`](tables_figures/SI_figures/composite_plots/SCBI.png){ width=85% }

\newpage
## `r GLS_SCBI_year_legend`

![`r GLS_SCBI_year_legend` `r GLS_generic_legend`](tables_figures/SI_figures/composite_plots/SCBI_with_Year.png){ width=85% }
...
![`r GLS_LT_legend` `r GLS_generic_legend`](tables_figures/SI_figures/composite_plots/NewMexico.png){ width=85% }
