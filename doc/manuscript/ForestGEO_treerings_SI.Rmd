...
*Climwin* is a useful analytical tool that automates the process of running and comparing numerous regressions, but its use does not alter results relative to what would be obtained via a more conventional approach; numerous climate drivers and seasonal windows can be compared without climwin [e.g., @meko_seascorr_2011], and *climwin* can also be used on residual or standard chronologies. 
