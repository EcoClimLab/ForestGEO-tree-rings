...
*Beta* coefficients, along with their standard error, were obtained for each month within the analysis time frame (Table `r site_details`) and for the seasonal window identified as optimal by *climwin*.
...
For PPT at LT, optimal seasonal windows pre-1970 and post-1970 were similar to those for the entire time period.
For the temperature variable at LT, $T_{max}$ was consistently identified as the most important variable, but it's optimal seasonal window extended back to the previous growing season pre-1970, but was limited to the current growing season post-1970 and for the analysis as a whole.
