...
GLS_LT_year_legend = "Figure S13. Best GLS models including climate, DBH, and year for LT"
...
![`r GLS_LT_year_legend` `r GLS_generic_legend`](tables_figures/SI_figures/composite_plots/NewMexico_with_Year.png){ width=85% }
