...
Here, we develop and apply a new method that allows simultaneous consideration of the effects of principal climate drivers (pre-selected in an objective manner), tree size, and year on annual tree growth.
