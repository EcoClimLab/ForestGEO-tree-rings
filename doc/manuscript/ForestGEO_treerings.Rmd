...
We found that interactions between climate variables and DBH were common (`r round(n_DBHx_analyzed_sig/ n_DBHx_analyzed*100)`% of total cases analyzed;  Table `r hypotheses`, Figs. `r interactions_fig`, `r RW_interactions_all`).
