...
However, the predominantly negative temperature responses (Fig. `r clim_sens`) imply that warmer temperatures are likely to reduce growth at most of the sites analyzed here, in large part by exacerbating observed water limitations (**REFS**).
