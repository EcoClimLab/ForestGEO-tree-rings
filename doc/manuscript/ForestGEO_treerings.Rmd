...
Approaches that ...., such as regional curve standardization, perform better at growth trend detection [@peters_detecting_2015].
...
ft <- italic(ft, i=c(1,15,22), j=1)
ft <- bold(ft, i=c(1,15,22, 2,6,12,16,19, 23, 25))
