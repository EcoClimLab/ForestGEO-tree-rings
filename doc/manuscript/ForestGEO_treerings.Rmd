...
The smoothing parameters were automaticaly selected by the *gam* function by generalized cross-validation (GCV).
...
In secondary stands, particularly those where many of the sampled species recruited in pulses that were followed by low recruitment (e.g., SCBI, HF; Appendix `r site_details_appendix`, Figs. `r all_recruitment_plots`), growth declines are consistent with the tendency for faster tree growth during early succession [@lorimer_estimating_1988; @lorimer_methodology_2011], and with increasing competition and declining woody productivity as young stands mature [e.g., @goulden_patterns_2011; @pregitzer_carbon_2004].
