...
For each of these drivers individually, the method yields results that are consistent with those that would be obtained using established methods (Figs. `r SCBI_example`, `r all_traditional_comparisons`;  Table `r qualitative_results_comparison`; see also Appendix `r traditional_comparison`). 
...
However, our results remain subject to some potential sampling and survivorship biases that can influence overall trends in positive or negative directions [Fig. `r year_fig`, @brienen_detecting_2012;@nehrbass-ahles_influence_2014; @groenendijk_no_2015; @brienen_tree_2017; @vandersleen_trends_2017].
