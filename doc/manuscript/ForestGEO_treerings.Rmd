...
We hypothesize that they commonly influence growth over different seasonal windows (Table `r hypotheses`) such that their effects cannot be fully captured by a single metric such as the Standardised Precipitation-Evapotranspiration Index [SPEI, @vicente-serrano_multiscalar_2010].
