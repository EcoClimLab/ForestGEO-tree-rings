...
First, moisture and temperature are known to jointly shape tree growth [@beedlow_importance_2013; @foster_predicting_2016] and forest productivity [e.g., @alexander_relative_2018; @banburymorgan_global_2021], yet growth sensitivity to their additive or interactive effects is not commonly considered [but see @foster_predicting_2016; @meko_seascorr_2011;  @sanchez-salguero_disentangling_2015].
While drought metrics such as the Standardised Precipitation-Evapotranspiration Index [SPEI, REF] are commonly used to assess the joint influence of moisture and temperature, we hypothesize hypothesize that they commonly influence growth over different seasonal windows (Table `r hypotheses`) such that their effects cannot be fully captured by a single metric such as SPEI.
...
Rising atmospheric CO~2~ concentrations, and changes in atmospheric deposition of sulfur dioxide (SO~2~) and nitrogen oxides (NO~x~), and indirect effects of climate change are all potentially influencing tree growth [@levesque_water_2017; @mathias_disentangling_2018; @maxwell_higher_2019; @walker_integrating_2020; @takahashi_air_2020; @belmecheri_precipitation_2021], and understanding these effects is central to predicting the future of the terrestrial carbon sink [@walker_integrating_2020].
