...
Our novel method provides a powerful approach to simultaneously consider the effects of climate, tree size, slowly changing environmental conditions, and their interactions on annual tree growth (Fig. `r schematic`).
For each of these drivers individually, the method yields results that are consistent with those that would be obtained using established methods (Figs. `r SCBI_example`, `r all_traditional_comparisons`;  Table `r qualitative_results_comparison`). 
