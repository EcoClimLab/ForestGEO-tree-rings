...
**Title:** Using tree-ring records to simultaneously characterize the influence of climate, tree size, and slowly changing environmental drivers on annual tree growth
...
However, traditional dendrochronology methods aggregate growth records of multiple trees -- often limited to dominant canopy individuals -- into standardised or residual chronologies, and therefore cannot simultaneously account for the effects of climate, slowly changing environmental drivers, age and tree size.
...
Here, we develop a new method that allows simultaneous consideration of the effects of principal climate drivers (pre-selected in an objective manner), tree size, and year on annual tree growth.
