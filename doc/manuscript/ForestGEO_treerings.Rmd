...
Directional climate change (as opposed to interannual variation), rising atmospheric CO~2~, and changes in atmospheric deposition of sulfur dioxide (SO~2~) and nitrogen oxides (NO~x~) are all potentially influencing tree growth [e.g., @levesque_water_2017; @mathias_disentangling_2018; @walker_integrating_2020; @takahashi_air_2020].
...
We analyzed tree-ring data, most previously collected, from 10 sites ranging from 9.15$^\circ$ to 61.30$^\circ$ N latitude and representing a wide range of forest and tree types: tropical broadleaf deciduous and evergreen, temperate broadleaf deciduous and needleleaf evergreen (conifer), and boreal needleleaf evergreen (Tables `r sites`, `r site_details`, `r species_table`).
