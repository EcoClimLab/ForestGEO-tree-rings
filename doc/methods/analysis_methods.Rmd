...
2.2. For each species independently, run GAM models including every combination of climate variables (as a 2-degree polynomial to allow quadratic curve), and fit one year spline for each treeID, plus a random intercept for each tree. We will also run models with a spline of DBH (3 knots). 
