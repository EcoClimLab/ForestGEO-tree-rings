...
1.2. We use climate data from CRU v. 4.04. Based on how variables are related to one another, and how they are derived in CRU [Harris et al. 2020](https://rdcu.be/b3U3e), we grouped variables as follows, using climwin to eselct the best variable and time window for each: 
...
We put the residuals derived in step 1.1 in *climwin* with a mixed effects model using species and tree identity as random effect: `ln[residual] ~ [climate] +  + (1 | sp) + (1 | treeID)`. 
